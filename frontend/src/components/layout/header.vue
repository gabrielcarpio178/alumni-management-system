    ...
    <header class="fixed w-full z-50">
        <nav class="bg-gray-200 border-gray-300 px-4 lg:px-6 py-2.5 dark:bg-gray-800 shadow">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2" v-if="this.showNavi">
                ...
                <div v-if="this.showNavi" :class="this.novi_show?'block':'hidden'" class="block justify-between items-center w-full lg:flex lg:w-auto lg:order-1">
                    <ul class="gap-y-2 flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li v-if="this.isLogin" class="p-1 rounded-md" :class="isActivate('alumni')?'dark:bg-gray-700 bg-gray-100':'hover:bg-gray-100 dark:hover:bg-gray-700'">
                            <router-link to="/alumni" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Alumni</router-link>
                        </li>
