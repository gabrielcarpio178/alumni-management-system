<template>
    <footer class="shadow-black shadow-md mt-5 bg-gray-200 dark:bg-gray-800 border-gray-200 dark:text-white w-screen">
        <div class="text-center py-1">
            <h1 class="text-3xl font-bold">Contact Us</h1>
            <div class="flex md:flex-row flex-col items-center justify-center gap-10 mt-5">
                <div class="flex flex-row items-center gap-x-3">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="dark:fill-white md:w-20 md:h-20 w-10 h-10">
                    ...
                    <h2 class="md:text-2xl text-xs font-bold">
